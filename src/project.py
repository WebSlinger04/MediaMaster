...
def gui_init(art):
    ...
    art.define_shape(pos=(240,325), size=(55,30),id="Format,webm")
    art.define_shape(pos=(305,325), size=(55,30),id="Format,3gp")
    ...
    art.define_text(text=f"AVI{" "*14}MOV{" "*13}MKV{" "*11}WEBM{" "*11}3GP",pos=(62,335),size=12)
